...
class QRCode(Base):
    ...
    name: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment="Human-readable name (e.g., '展示会2025')"
    )
    ...
    short_url: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment="Short URL (e.g., https://dgnl.ds/abc123)"
    )
    ...
    qr_code_image_url: Mapped[str | None] = mapped_column(
        String(500),
        comment="S3/R2 URL for PNG image"
    )
    qr_code_svg_url: Mapped[str | None] = mapped_column(
        String(500),
        comment="S3/R2 URL for SVG image"
    )
    ...
    enabled: Mapped[bool] = mapped_column(
        ...
        nullable=False,
        default=True,
        comment="Whether QR code is active"
    )
