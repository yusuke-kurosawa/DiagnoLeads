...
def test_get_lead_analytics(client: TestClient, db_session: Session, test_user: User):
    ...
    leads_data = [
        {"name": "Hot Lead 1", "email": "hot1@example.com", "status": "qualified", "score": 80},
        {"name": "Hot Lead 2", "email": "hot2@example.com", "status": "converted", "score": 90},
        {"name": "Warm Lead", "email": "warm@example.com", "status": "contacted", "score": 45},
        {"name": "Cold Lead 1", "email": "cold1@example.com", "status": "new", "score": 20},
        {"name": "Cold Lead 2", "email": "cold2@example.com", "status": "disqualified", "score": 10},
    ]
