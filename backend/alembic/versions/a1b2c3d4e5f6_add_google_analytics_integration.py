...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('track_frontend', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('track_embed_widget', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('track_server_events', sa.Boolean(), nullable=False, server_default='false'),
    ...
    # Create indexes
    op.create_index(
        'ix_ga_integration_tenant_id',
        'google_analytics_integrations',
        ['tenant_id']
    )
    op.create_index(
        'ix_ga_integration_enabled',
        'google_analytics_integrations',
        ['enabled']
    )
