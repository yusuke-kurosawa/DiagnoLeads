...
def upgrade() -> None:
    ...
    op.create_index('idx_question_options_question_order', 'question_options', ['question_id', 'order'])
    ...
    op.create_index('idx_responses_assessment_completed', 'responses', ['assessment_id', 'completed_at'])
