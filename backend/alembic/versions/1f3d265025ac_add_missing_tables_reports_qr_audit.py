...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "report_type", sa.String(length=50), nullable=False, comment="custom|lead_analysis|assessment_performance|conversion_funnel|ai_insights"
        ),
        sa.Column(
            "config",
            sa.JSON(),
    ...
    op.alter_column("error_logs", "request_body", existing_type=postgresql.JSONB(astext_type=sa.Text()), type_=sa.JSON(), existing_nullable=True)
    op.alter_column("error_logs", "request_headers", existing_type=postgresql.JSONB(astext_type=sa.Text()), type_=sa.JSON(), existing_nullable=True)
    op.alter_column("error_logs", "response_body", existing_type=postgresql.JSONB(astext_type=sa.Text()), type_=sa.JSON(), existing_nullable=True)
    op.alter_column("error_logs", "context", existing_type=postgresql.JSONB(astext_type=sa.Text()), type_=sa.JSON(), existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column("error_logs", "context", existing_type=sa.JSON(), type_=postgresql.JSONB(astext_type=sa.Text()), existing_nullable=True)
    op.alter_column("error_logs", "response_body", existing_type=sa.JSON(), type_=postgresql.JSONB(astext_type=sa.Text()), existing_nullable=True)
    op.alter_column("error_logs", "request_headers", existing_type=sa.JSON(), type_=postgresql.JSONB(astext_type=sa.Text()), existing_nullable=True)
    op.alter_column("error_logs", "request_body", existing_type=sa.JSON(), type_=postgresql.JSONB(astext_type=sa.Text()), existing_nullable=True)
